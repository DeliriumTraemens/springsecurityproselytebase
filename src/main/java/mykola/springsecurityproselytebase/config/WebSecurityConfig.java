...
//                .antMatchers(HttpMethod.DELETE, "/api/**").hasAuthority(Permission.DEVELOPERS_WRITE.getPermission())
                ...
                //\/ Change logout HttpMethod to POST
                .logoutRequestMatcher(new AntPathRequestMatcher("/auth/logout", "POST"))
                .invalidateHttpSession(true)//чистка Сессии
                .clearAuthentication(true)//чистка аутентификации
                .deleteCookies("JSESSIONID")//килл кукиз
